...
let firstUlLi = document.body.children[5].children[0];
console.dir(firstUlLi);
firstUlLi.innerText = "all about document";
...
let attrPassword = document.querySelector("#remember");
// 10. Select all the `li` element and store in `allTopics`
let allTopics = document.querySelectorAll("li");
// 11. Select all the input element of any type and store in `allInput`
let allInput = document.querySelectorAll("input");
// 12. Use forEach to console the `innerText` property of all the li element in `allTopics` variable.
console.dir(allTopics);
allTopics.forEach((element) => allTopics);
...
console.dir(allImgElement);
console.log(`The total number of img element is ${allImgElement.length}.`);
// 16. Select all the `p` element and store in `allPElement`
let allPElement = document.querySelectorAll("p")
// 17. Select all the buttons and log the count of buttons.
let allBtn = document.querySelectorAll("button");
console.log(`The total number of button is ${allBtn.length}.`);
...
let allElementWithIdTest = document.querySelectorAll("#test");

// 20. Select the first element with id `test` using `getElementById`
document.getElementById("test");

// 21. Select the parent element of the element stored in `topics` variable (#5) and log the element.
let topicsElement = document.querySelectorAll("li")
console.log(topicsElement.parentElement);
