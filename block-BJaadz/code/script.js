...
let imgHr = document.querySelectorAll("hr.image").forEach(elm => elm.style.border = "2px solid purple");
...
newPara3.innerText = "Prepend inserts as first child";
